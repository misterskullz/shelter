...
local general_fail = {name = 'shelter_fail', gain=1.0}
...
local sound_grass_fail =  general_fail
...
local sound_dirt_fail =  general_fail
...
local sound_sand_dig =   {name='shelter_sand_dig', gain=0.3} 
...
local sound_sand_fail =  general_fail
...
local sound_gravel_fail =  general_fail
...
local sound_wood_fail =  general_fail
...
local sound_leaves_fail =  general_fail
...
local sound_stone_dig =   {name='shelter_stone_dig', gain=0.5}
...
local sound_stone_fail =  general_fail
...
local sound_glass_fail =  general_fail
